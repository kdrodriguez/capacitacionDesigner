...
function VC_CUENTASYJQ_588820(cobisMainModule) {
    ...
    cobisMainModule.controllerProvider.register("VC_CUENTASYJQ_588820_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            "${contextPath}/resources/INTRD/FRMCN/T_INTRDYRASIXRJ_820",
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.createViewState({
                ...
                hasId: true,
                componentStyle: [],
                label: "INTRD.LBL_INTRD_CUANTEOIR_64349",
            ...
            $scope.vc.createViewState({
                ...
                componentStyle: [],
                label: "INTRD.LBL_INTRD_NMEROCUAE_52109",
                validationCode: 0,
            ...
            $scope.vc.createViewState({
                ...
                componentStyle: [],
                label: "INTRD.LBL_INTRD_VALORATIR_88929",
                format: "n",
                decimals: kendo.cultures.current.numberFormat.decimals,
                validationCode: 32,
                readOnly: designer.constants.mode.Query,
            ...
            $scope.vc.createViewState({
                ...
                componentStyle: [],
                label: "INTRD.LBL_INTRD_TRANSFERR_88817",
                validationCode: 0,
            ...
            $scope.vc.createViewState({
                ...
                hasId: true,
                componentStyle: [],
                label: "INTRD.LBL_INTRD_CUENTADEE_38041",
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_CUENTASYJQ_588820", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "INTRD"]);
